...
La facilitación permitirá modificar un microambiente, lo que le permitirá o no a una especie tener una amplia diversidad debido a los niveles de estrés. Además se podrá observar si hay más diversidad de especies comunes o especies poco comunes en el área de estudio.
